    ...
    <Card className={classes.root}>
      <CardActionArea className={classes.action}>
        <CardMedia
          ...
          image={data?.avatar_url?data.avatar_url: mockAvatarUrl}
